...
//NetworkInterface n = NetworkInterface.getByName("wlan");
//NetworkInterface n = NetworkInterface.getByName("eth3");
//Enumeration ee = n.getInetAddresses();
InetAddress IPorigen=null;
IPorigen = InetAddress.getByName("8.120.0.220");
  /*  while (ee.hasMoreElements())
    {
        InetAddress ii = (InetAddress) ee.nextElement();
        System.out.println("IP: "+ii.getHostAddress());
    ...
    //IPorigen = InetAddress.getByName("8.9.0.82");
      byte[]IPo =IPorigen.getAddress();
        ...
        String ip;
            Scanner leer = new Scanner(System.in); 
        		public void nextPacket(PcapPacket packet, String user) {
                            if(i==0){
                                System.out.println("Ingresa la direccion ip");
                                ip = leer.nextLine();
                                System.out.println("IP a buscar: "+ip);
                            }
                            int operacion = (packet.getUByte(20)==0)?packet.getUByte(21):(packet.getUByte(20)*256)+packet.getUByte(21);
                            String ipp="";
                            //System.out.println("Direccion IP: ");
                                for(int i=38;i<42;i++){
                                    int a = packet.getUByte(i) &255;
                                    if(i==41)
                                        ipp += a;
                                    else
                                        ipp+=a+".";
                                ...
                                System.out.println("ip a comparar: "+ipp+" y operacion: "+operacion);
                            //String operacion2 = Integer.toBinaryString(packet.getUByte(21));    
                            //System.out.println("operwcion : "+operacion);
                            //int operacion = Integer.parseInt(operacion);
                            //&& ip.equals(ipp)
                            if(ip.equals(ipp) && operacion == 2){    
                                ...
                                System.out.println("ip a comparar: "+ipp);
                                System.out.println("numero: "+i);
                                //if(packet.getUByte(21))
                                /******Desencapsulado********/
                                ...
                                System.out.println("\n\n");*/
                                //String operacion1 = Integer.toBinaryString(packet.getUByte(20));
                                //String operacion2 = Integer.toBinaryString(packet.getUByte(21));
